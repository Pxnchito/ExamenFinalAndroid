...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgOnepieceLogo;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_onepiece_logo;
      ImageView imgOnepieceLogo = ViewBindings.findChildViewById(rootView, id);
      if (imgOnepieceLogo == null) {
        break missingId;
      }

...
public final class FragmentOnePieceFavoriteBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentOnePieceFavoriteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentOnePieceFavoriteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_one_piece_favorite, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);

...
public class InfoFragmentDirections private constructor() {
  private data class ActionInfoFragmentToOnePieceDetailFragment(
    public val onepiece: OnePiece
  ) : NavDirections {
    public override val actionId: Int = R.id.action_infoFragment_to_onePieceDetailFragment
  ...
  public companion object {
    public fun actionInfoFragmentToOnePieceDetailFragment(onepiece: OnePiece): NavDirections =
        ActionInfoFragmentToOnePieceDetailFragment(onepiece)
  }
}

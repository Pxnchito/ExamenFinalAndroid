...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navHostFragment = supportFragmentManager.findFragmentById(R.id.fcv_onepiece) as NavHostFragment
        val navController = navHostFragment.navController
        binding.onepieceBnv.setupWithNavController(navController)
    }
}